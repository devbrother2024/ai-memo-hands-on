...
-   [ ] 비밀번호 재설정 기능 구현 (AC: 1, 2, 3, 4, 5)
    -   [ ] 기존 비밀번호 찾기 페이지 기능 완성
    -   [ ] 비밀번호 재설정 이메일 발송 서버 액션 구현
    -   [ ] 비밀번호 재설정 페이지 구현 (`/auth/reset-password`)
    -   [ ] 새 비밀번호 설정 폼 컴포넌트 구현
    -   [ ] 비밀번호 강도 검증 및 확인 로직
    -   [ ] 재설정 완료 후 로그인 페이지 리다이렉트
    -   [ ] 에러 핸들링 및 사용자 친화적 메시지
-   [ ] 로그아웃 기능 구현 (AC: 6, 7, 8, 9)
    -   [ ] 메인 페이지 로그아웃 버튼 기능 연결
    -   [ ] 로그아웃 확인 다이얼로그 컴포넌트 구현
    -   [ ] 로그아웃 서버 액션 구현
    -   [ ] 세션 종료 및 로그인 페이지 리다이렉트
    -   [ ] 로그아웃 후 보호된 페이지 접근 방지 확인
